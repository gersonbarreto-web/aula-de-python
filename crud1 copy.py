...
def encontra_cliente_por_email(lista_clientes, nome_buscar):
...
def atualizar_clientes(lista_clientes):
    ...
    cliente_para_atualizar = encontra_cliente_por_email(lista_clientes, nome_buscar)
...
def excluir_cliente(lista_clientes):
    ...
    cliente =encontra_cliente_por_email(lista_clientes, email_busca).lower

    cliente_para_excluir = None
    for cliente in lista_clientes:
        if cliente.email.lower() == email_busca:
            cliente_para_excluir = cliente
            break
